...
const REPO = 'https://github.com/jackwangxyw/Bluebank'

/**
 * The GitHub mark. Inline rather than added to Icon.tsx, which is a set of
 * 24x24 stroke icons; this is a filled logo and would need a fill path in a
 * component whose whole contract is `stroke`.
 */
function GithubMark() {
  return (
  ...
  return (
    <div className="about">
      ...
      <section className="about-block">
        ...
        <a className="ghbtn" href={REPO} target="_blank" rel="noreferrer">
          <GithubMark />
          View on GitHub
        </a>
      </section>
